...
- Set up Docker on the EC2 instance:
  ...
  sudo usermod -aG docker $USER  # Replace with your system's username, e.g., 'ubuntu' (command not compulsory)
  newgrp docker
...
> ```
>
> This will allocate random name to container and does not conflict with existing containers.

If you get docker login failed error, then execute below commands in ec2 jenkins terminal:
